...
21 tools are always registered. With `IRIS_WORKSPACE` set, 5 workspace-gated
tools are added (up to 25 total). With `IRIS_DEBUG_ENABLED=true`, 9 debugger
tools are added (up to 34 total). See [MCP tools](../mcp/tools.md) for
