...
│   └── *.py            # One module per tool domain (14 always + 5 gated + 9 debug)
...
|----------|-------|-----------|
| Always-on | 14 | Always registered (including `index_code`, `index_callers`, `index_reachability` and `monitor_system`) |
